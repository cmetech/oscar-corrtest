...
func PublicContract() Contract {
	return Contract{APIVersion: APIVersion, Kind: Kind, Fields: []FieldDefinition{
		...
		field("event.delay", "Event", "delay", "Go duration", Optional, nil, "non-negative absolute offset; non-decreasing in declaration order; within scenario and observation budgets", "Immediate injection.", "", "Schedules deterministic injection order without accumulating adjacent delays.", "delay: 1m30s", "A decreasing delay or delay beyond the case budget is invalid."),
