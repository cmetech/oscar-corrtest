...
install -m 0644 "$root_dir/docs/scenario-authoring.md" "$package_root/docs/scenario-authoring.md"
install -m 0644 "$root_dir/docs/service-management.md" "$package_root/docs/service-management.md"
